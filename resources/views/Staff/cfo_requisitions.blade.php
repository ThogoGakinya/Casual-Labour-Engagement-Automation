                  ...
                  <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                    <table class="customers-actions">
                      ...
                      @endphp
                      <tbody>
                        @foreach($cfo_requisitions as $requisition)
                        <tr>
                        <td>{{$cnt}}</td>
                            ...
                            <td>
                            <a href="{{url ('/cfo_request/'.$requisition->token_id)}}" class="btn btn-success btn-xs editbtn" id="edit_goal"><i class="fa fa-eye"></i>&nbsp;&nbsp;View</a>
                            </td>
                        </tr>
                        @php
                          $cnt++
