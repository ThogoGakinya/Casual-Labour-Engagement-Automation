    ...
    @section('content')
        ...
        <section class="content">
            ...
            <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active_tab1" id="list_personal_details" style="border:1px solid #ccc">H.O.D</a>
                  </li>
                  <li class="nav-item">
...
<!--Start of requisition tab-->
       ...
       @foreach($specific_requisition as $specific)                    
        <div class="row">
          <div class="col-md-12">
            <!-- The time line -->
            <div class="timeline">
...
<!--Start of other approvals-->
             <div>
              ...
              <div>
                 <a href="{{route ('hod_requisitions')}}" class="btn btn-primary btn-sm" id="edit_goal"><i class="fas fa-arrow-circle-left"></i>&nbsp;&nbsp;Back</a>         
              </div>
@endforeach
          </div><!-- /.container-fluid -->
        </section>
