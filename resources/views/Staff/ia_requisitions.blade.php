                  ...
                  <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                    <table class="customers">
                      ...
                      @endphp
                      <tbody>
                        @foreach($ia_requisitions as $requisition)
                        <tr>
                        <td>{{$cnt}}</td>
                            ...
                            <td>
                                @if($requisition->hod_approval_status == 0)
                                    <button type="button" class="btn btn-warning btn-xs"><i class="fas fa-spinner"></i></button>
                            ...
                            @if($requisition->process_status == 20)
                                <div class="progress mb-3">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="{{$requisition->process_status}}" aria-valuemin="0"
                            ...
                            @elseif($requisition->process_status == 40)
                                <div class="progress mb-3">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="{{$requisition->process_status}}" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {{$requisition->process_status}}%">
                                        {{$requisition->process_status}}%
                                    </div>
                                </div>
                            @elseif($requisition->process_status == 60)
                                <div class="progress mb-3">
                                    <div class="progress-bar bg-success" role="progressbar" aria-valuenow="{{$requisition->process_status}}" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {{$requisition->process_status}}%">
                                        {{$requisition->process_status}}%
                                    </div>
                                </div>
                            ...
                            <td>
                            @if($requisition->documents_approval_status == 0)
                              <a href="{{url ('/ia_request/'.$requisition->token_id)}}" class="btn btn-primary btn-xs editbtn" id="edit_goal"><i class="fa fa-eye"></i>&nbsp;&nbsp;View</a>
                            @else
                              <a href="{{url ('/ia_request/'.$requisition->token_id)}}" class="btn btn-primary btn-xs editbtn" id="edit_goal"><i class="fa fa-eye"></i>&nbsp;&nbsp;Check</a>
                            @endif
                            </td>
                        </tr>
                        @php
