    ...
    @section('content')
        ...
        <section class="content">
            ...
            <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active_tab1" id="list_contact_details" style="border:1px solid #ccc">Budgeting</a>
                  </li>
                  <li class="nav-item">
...
<!--Start of requisition tab-->
       ...
       @foreach($specific_budget_requisition as $specific)                    
        <div class="row">
          <div class="col-md-12">
            <!-- The time line -->
            <div class="timeline">
  ...
  <!--Start of Budgetting tab-->
              <div>
                    ...
                    @endif
                    <div class="timeline-item">
                        <span class="time">Approved on :&nbsp;<i class="fas fa-clock"></i> {{$specific->budget_approval_date}}</span>
                        <h3 class="timeline-header"><a href="#">Budgetting approval</a></h3>
            ...
            @else 
                ...
                @else 
                    ...
                    @if($specific->budget_approval_status == 0)
                        <div class="timeline-footer">
                            <button type="button" class="btn btn-primary btn-sm" data-approvalid="{{$specific->id}}" data-amount="{{$specific->amount}}" data-toggle="modal" data-target="#approve"><i class="fas fa-check"></i>&nbsp;Approve</button>
                    ...
                    @elseif($specific->budget_approval_status == 1)
                        <div class="timeline-footer">
                            <button type="button" class="btn btn-success btn-xs"><i class="fas fa-check"></i>&nbsp;Approved</button>
                             by {{$specific->budget_approver->name}}
                        </div>
                    @elseif($specific->budget_approval_status == 2)
                        <div class="timeline-footer">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" align="center">Budget Request</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                    <form method="post"  class="form-horizontal" action="{{route('budget_approve_request','test')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     @method('put')
                     <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                           <select class="form-control" id="budget" name="budget" required></select>
                        </div>
                    </div><br/>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                          <select class="form-control" id="mtdbf" name="mtdbf" required></select>
                        </div>
                    </div><br/>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control" name="mtdcurrent" id="mtdcurrent" value="">
                          <input type="hidden" class="form-control" name="approval_id" id="approval_id" value="">
                          <input type="hidden" class="form-control" name="budget_id"  value="{{auth::user()->id}}">
                        </div>
                    </div>
            </div>
...
<div class="modal fade" id="decline" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form method="post"  class="form-horizontal" action="{{route('budget_decline_request','test')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     @method('put')
