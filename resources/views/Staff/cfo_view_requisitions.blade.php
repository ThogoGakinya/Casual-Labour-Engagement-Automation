    ...
    @section('content')
        ...
        <section class="content">
            ...
            <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active_tab1" id="list_contact_details" style="border:1px solid #ccc">C.F.O</a>
                  </li>
                  <li class="nav-item">
...
<!--Start of requisition tab-->
       ...
       @foreach($specific_cfo_requisition as $specific)                    
        <div class="row">
          <div class="col-md-12">
            <!-- The time line -->
            <div class="timeline">
  ...
  <!--Start of Budgetting tab-->
              <div>
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header"><a href="#">Chief Finance Office (CFO) Approval</a></h3>
...
<!--Start of other approvals-->
             <div>
              ...
              <div>
                 <a href="{{route ('cfo_requisitions')}}" class="btn btn-primary btn-sm" id="edit_goal"><i class="fas fa-arrow-circle-left"></i>&nbsp;&nbsp;Back</a>         
              </div>
@endforeach
          </div><!-- /.container-fluid -->
        </section>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form method="post"  class="form-horizontal" action="{{route('cfo_approve_request','test')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     @method('put')
                    <input type="hidden" class="form-control" name="approval_id" id="approval_id" value="">
                    <input type="hidden" class="form-control" name="cfo_id"  value="{{auth::user()->id}}">
            </div>
...
<div class="modal fade" id="decline" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form method="post"  class="form-horizontal" action="{{route('cfo_decline_request','test')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     @method('put')
