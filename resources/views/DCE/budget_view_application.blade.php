    ...
    @section('content')
        ...
        <section class="content">
            ...
            <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active_tab1" id="list_contact_details" style="border:1px solid #ccc">Budget Officer</a>
                  </li>
...
<!--Start of requisition tab-->
        ...
        @else
           <div>
                    ...
                    @elseif($approvals->budget_approval == 1)
                        <div class="timeline-footer">
                            <button type="button" class="btn btn-success btn-xs"><i class="fas fa-check"></i>&nbsp;Budgeted</button>
                             by {{$approvals->budgetofficer->name}}
                        </div>
                    @elseif($approvals->budget_approval == 2)
                        <div class="timeline-footer">
        ...
        <!--Start of other approvals-->       
            <div>
                 <a href="{{url ('budget/applications')}}" class="btn btn-default btn-sm" id="edit_goal"><i class="fas fa-arrow-circle-left"></i>&nbsp;&nbsp;Back</a>         
            </div>
          </div><!-- /.container-fluid -->
        </section>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form method="post"  class="form-horizontal" action="{{route('budget_approve_dce_request','test')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     @method('put')
...
<div class="modal fade" id="decline" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form method="post"  class="form-horizontal" action="{{route('decline_budget_request','test')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     @method('put')
