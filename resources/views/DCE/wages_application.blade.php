    ...
    @section('content')
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h5 class="m-0 text-dark">Wages Daily Casuals Requisition</h5>
              </div><!-- /.col -->
              <div class="col-sm-6">
                ...
                <div class="tab-content" style="margin-top:16px;">
                 <div class="tab-pane active" id="login_details">
                  <div class="panel panel-default">
                   ...
                   <a href="{{route ('casuals')}}" class="btn btn-default btn-sm" ><i class="fas fa-arrow-circle-right"></i>&nbsp;&nbsp;Manage Casuals</a> 
                   <a href="{{route ('reports')}}" class="btn btn-default btn-sm" ><i class="fa fa-file"></i>&nbsp;&nbsp;Reports</a> 
                   </div>
                    ...
                    <table class="customers-actions">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('wages_view_application',$application->token_id)}}" class="btn btn-success btn-xs editbtn" id="edit_Application"><i class="fa fa-eye"></i>&nbsp;&nbsp;View</a>
                            </td>
                        </tr>
                        @php
                          $cnt++
