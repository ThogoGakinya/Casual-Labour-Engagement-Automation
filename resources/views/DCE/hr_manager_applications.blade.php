    ...
    @section('content')
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h5 class="m-0 text-dark">H.R Manager Daily Casuals Requisition</h5>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{ route('home')}}">Dashboard</a></li>
                  <li class="breadcrumb-item active">Casuals</li>
                  <li class="breadcrumb-item active">H.R Manager</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                    ...
                    <table class="customers-actions">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('hr_manager_view_application',$application->token_id)}}" class="btn btn-success btn-xs editbtn" id="edit_Application"><i class="fa fa-eye"></i>&nbsp;&nbsp;View</a>
                            </td>
                        </tr>
                        @php
                          $cnt++
